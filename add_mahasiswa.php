...
<body id="page-top">
 ...
 <?php 
  ...
  if (isset($_POST['Submit'])){
   ...
   $email = $_POST['email'];
   $idprodi = $_POST['id_program_studi'];
   //insert user into table
   $result = mysqli_query($connection, "INSERT INTO mhs(nrp,nama,jenis_kelamin,alamat,tanggal_lahir,program_studi,email,id_program_studi) VALUES('$nrp','$nama','$jenis_kelamin','$alamat','$tanggal','$email','$idprodi')");
   
   echo '<div class="alert alert-primary" role="alert"> Data Mahasiswa berhasil ditambahkan ! </div>';
  ...
  <section class="page-section" id="add-user">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mhs.php" method="post" novalidate="novalidate" entype = "multipart/form-data">
   ...
   <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="jenis_kelamin" name="jenis_kelamin" type="text" placeholder="Masukkan Jenis Kelamin" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control datepicker" id="tanggal" name="tanggal" type="text" placeholder="Masukan Tanggal" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
   <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Email</label>
                <input class="form-control" id="email" name="email" type="text" placeholder="Masukkan Email" required="required">
    <p class="help-block text-danger"></p>
              </div>
            </div>
   <div class="control-group">
              <div>
                ...
                <select name="id_prodi_studi" class="form-control">
